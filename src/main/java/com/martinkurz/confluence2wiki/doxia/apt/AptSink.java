package com.martinkurz.confluence2wiki.doxia.apt;
...
/**
 * APT generator implementation. <br/>
 * <b>Note</b>: The encoding used is UTF-8.
 * 
 * @author eredmond
 * @version $Id: AptSink.java 1438269 2013-01-24 23:47:50Z olamy $
 * @since 1.0
 */
public class AptSink extends AbstractTextSink implements AptMarkup {
    ...
    public void numberedListItem() {
        ...
        if (style.equals(String.valueOf(STAR))) {
            ...
            write(EOL + listNestingIndent + String.valueOf(LEFT_SQUARE_BRACKET) + String.valueOf(LEFT_SQUARE_BRACKET) + style
                + String.valueOf(RIGHT_SQUARE_BRACKET) + String.valueOf(RIGHT_SQUARE_BRACKET) + String.valueOf(SPACE));
        }
        itemFlag = true;
    }
